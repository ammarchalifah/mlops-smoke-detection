...
def prepare_data(train_path):
    ...
    features = ['UTC', 'Temperature', 'Humidity', 'TVOC', 'eCO2', 'Raw H2', 'Raw Ethanol', 'Pressure', 'PM1.0', 'PM2.5', 'NC0.5', 'NC1.0', 'NC2.5', 'CNT']
    label = 'Fire Alarm'
...
def train_model_exploration(df_X, df_y, model):
    ...
    models = {"Random Forest":RandomForestClassifier(n_jobs=-1), "LightGBM": LGBMClassifier(n_jobs=-1),
            "XGBoost": XGBClassifier(n_jobs=-1), "CatBoost": CatBoostClassifier(silent=True)}
